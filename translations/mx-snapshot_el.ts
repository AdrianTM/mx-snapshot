...
<context>
    ...
    <message>
        ...
        <translation>Μπορείτε επίσης να εξαιρεθούν ορισμένες καταλόγους τσεκάροντας τις κοινές επιλογές παρακάτω, ή κάνοντας κλικ στο κουμπί για να επεξεργαστείτε άμεσα /etc/mx-snapshot-exclude.list</translation>
    </message>
    <message>
