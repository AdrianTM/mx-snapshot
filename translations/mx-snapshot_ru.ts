...
<context>
    ...
    <message>
        ...
        <translation>Вы также можете исключить определенные папки, отметив их ниже, или нажать на кнопку, чтобы напрямую редактировать /etc/mx-snapshot-exclude.list.</translation>
    </message>
    <message>
